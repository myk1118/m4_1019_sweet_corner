...
module.exports = async (req, res, next) => {
    try {
        ...
        if (cart) {
            ...
            SELECT c.pid AS cartId, quantity, ci.pid AS itemId, ci.createdAt AS added,
            p.name, p.cost AS \`each\`, p.pid AS productId,
            (p.cost * quantity) AS total, altText, type, file
